...
**Problem-solving.** Anyone who has spent three days debugging a merge conflict or figuring out why their standard errors explode knows: research is full of moments where only lateral thinking gets you unstuck.

**Writing and storytelling.** You can have the most rigorous causal estimate in the world. If you cannot explain why it matters in plain language, it will not have impact. Hence, I push so hard on clear writing: short paragraphs, strong openings, no jargon shields.
...
Here is a truth that might feel counterintuitive in a course about GenAI: **many of my best ideas emerged away from the desk, and away from GenAI.** Running. Wood carving. Walking. You can see some of my hand-carved spoons in the picture. Each one is a small meditation.

This is not mysticism. There is solid neuroscience behind it. When you step away from focused work, your brain does not stop working on the problem. It just works differently.
...
> **Key insight**: Alternating focused work with intentional "off-task" periods can boost creativity. This is not procrastination. It is strategic disengagement.
...
**Switch modalities.** Do not code for eight hours straight. Alternate: code for a while, then read a paper, then write a paragraph, then do some admin. Each switch gives a different part of your brain room to breathe.
...
**Impact.** Why does it matter? Not just for the academic community, but for the real world. This is something I always push in my consulting work at Enlighten Advisory: so what? Who cares? What changes if this is true?
...
> **Key insight**: Avoid judging too early. It kills originality. The worst thing you can do in a brainstorming session is say "that will not work" before the idea has had time to breathe.
...
This also connects to the Acemoglu et al. (2026) paper on knowledge collapse that I have reviewed recently. When AI systems are trained on AI-generated content, the distribution of ideas narrows. The tails get thinner. The weird, wonderful, wrong-but-productive ideas disappear. The same logic applies when humans over-rely on AI for ideation.
...
This two-phase approach, generate with AI then evaluate with AI, is the pattern I use in my own multi-agent content pipeline. The `causal-content` skill generates concept angles, the `linkedin-agent` drafts, and then I apply my own convergent judgment to select and refine. The AI handles the volume. I handle the taste.
...
**Step 1: Upload 2 to 5 core PDFs** into a tool like NotebookLM, Claude, or any context-aware LLM. Ask it to extract from each paper: the research question, the method, the data, and the key findings.
...
Let me walk through the course framework, Before / During / After, applied to creativity and brainstorming specifically.

**BEFORE: Should I use GenAI?** Creativity benefits from productive struggle. Do your own brainstorming first, that 10 to 15 minute analog pass we just discussed. Ask yourself: do I want to develop my creative thinking (the process) or generate a list of ideas quickly (the outcome)? If process matters, start without AI and use it to expand later.

**DURING: Filter In and Filter Out.** Use divergent prompts ("give me 20 wild ideas"), then convergent ones ("rank by feasibility"). Upload your own notes or papers as context for more relevant ideation. Try multiple tools and compare, different models produce different creative styles. And always take the time to check the quality of the output and how it interprets its sources.

**AFTER: Evaluate and Adapt.** Were the AI-generated ideas better than your own, or complementary? Did AI help you think differently, or did it anchor your thinking? Next time, try varying the prompt style and comparing outputs. The meta-skill here is learning how to learn with AI.
...
The goal is not just to produce ideas. It is to develop a workflow for creative collaboration with AI that you can use throughout your research career. You now have the framework. Go test it.
...
Next week is your **mid-term presentation**. Time to show where your research project stands.

In two weeks, we move from creativity to execution: **Coding (vs. Vibe Coding) and Data Analysis (Vibe Data Science)**. We will dig into the difference between using AI to write code you understand versus using it as a black box that generates code you cannot debug. I have strong opinions on this. Stay tuned.
