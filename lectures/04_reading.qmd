...
> **Key insight**: Reading research is not just about extracting information. It trains your writing, sharpens your critical thinking, and helps you communicate precisely --- skills that no LLM can build for you.
...
> **Key insight**: Impact factor is a signal, not a verdict. Always compare within the same field, and watch out for sub-journals that look like the flagship.
...
> **Key insight**: After the first pass, you should know the main research question, how they answered it, and what the key limitations are. If you know this, you know whether to go further.
...
> **Key insight**: An LLM recalling a paper from training data is like you trying to remember something you read months ago. Uploading the paper puts it right in front of the model --- much more reliable, but still not perfect.
...
> **Key insight**: A strong research design does not eliminate all threats. Even a well-executed diff-in-diff can be challenged on SUTVA violations, confounding trends, and measurement choices. The value of deep reading is learning to identify these threats yourself.
