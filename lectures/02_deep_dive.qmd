...
> **Key insight**: If a complete "research paper" can be generated in ten minutes of human effort, the bottleneck shifts from production to verification. The implication for researchers is not that they become obsolete — it is that the nature of their work might changes, from executing less to evaluating more (or asking the right questions and collecting novel data).
