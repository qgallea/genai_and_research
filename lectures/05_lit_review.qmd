...
Welcome to session 5. Quick note: Quentin presented the class and project at the university press event yesterday, and it was well received — many people expressed interest in joining. So next year the class may be bigger, potentially including professors. But first, a debrief from last week's homework, then on to today's topic.
...
> **Key insight**: NotebookLM is a grounded model — it prioritizes its sources — but it still draws on general LLM knowledge to fill gaps, which can lead to subtle extrapolations. Always check the inline references, and feed it the right technical sources to get the depth you need.
...
> **Key insight**: Don't start with keyword search. Start with key authors and landmark papers, then mine citations backward and forward to map the field.
...
> **Key insight**: The literature review is not a neutral summary. It's a strategic argument that positions your research. Understanding the incentive structure of academia — for better and worse — helps you read literature reviews more critically and write them more effectively.
...
> **Key insight**: A great literature review reads like a story, not a list. It establishes importance, maps the landscape, and builds inevitably toward the gap your research fills.
...
> **Key insight**: Use AI where only the outcome matters (filtering, extracting, organizing). Do the work yourself where the process matters (evaluating quality, understanding arguments, making judgment calls about what's seminal).
